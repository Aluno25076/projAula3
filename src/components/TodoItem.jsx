...
function TodoItem({ task, ind, handleDeleteTask, handleShowModalEdit, handleCompletionTask }) {
    ...
    return <>
        <li className='d-flex justify-content-between list-group-item'>
            ...
            <span>Tarefa: {tarefaAux.userCriacao}</span>
            ...
            <div>
                ...
                */}
                ...
                <button onClick={() => { handleDeleteTask(tarefaAux) }} className='btn btn-danger'>
                    Delete
                </button>
            </div>
        </li>
